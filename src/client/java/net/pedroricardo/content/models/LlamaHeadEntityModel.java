...
public class LlamaHeadEntityModel extends SkullBlockEntityModel implements HeadedRewrittenModel {
    private final ModelPart root;
    private final ModelPart head;

    public LlamaHeadEntityModel(ModelPart root) {
        this.root = root;
        this.head = this.root.getChild(EntityModelPartNames.HEAD);
    }

    public static TexturedModelData getTexturedModelData(Dilation dilation) {
        return LlamaEntityModel.getTexturedModelData(dilation);
    }
    ...
    public Vector3f getHeadSizeInPixels() {
        return new Vector3f(8.0f, 16.0f, 6.0f);
    }
