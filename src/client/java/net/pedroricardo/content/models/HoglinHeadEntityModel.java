...
public class HoglinHeadEntityModel extends SkullBlockEntityModel implements HeadedRewrittenModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        return HoglinEntityModel.getTexturedModelData();
    }

    @Override
    public void setHeadRotation(float animationProgress, float yaw, float pitch) {
        yaw = yaw * 0.017453292f;
        pitch = (pitch + 22.5f) * 0.017453292f;
        float offsetZ = 8.0f;
    ...
    public Vector3f getHeadSizeInPixels() {
        return new Vector3f(14.0f, 6.0f, 10.0f);
    }
