...
public class SnifferHeadEntityModel extends SkullBlockEntityModel implements HeadedRewrittenModel {
    private final ModelPart root;
    private final ModelPart head;

    public SnifferHeadEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        return SnifferEntityModel.getTexturedModelData();
    }
    ...
    public Vector3f getHeadSizeInPixels() {
        return new Vector3f(15.0f, 15.0f, 16.0f);
    }

    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
        matrices.translate(0.0f, -0.469375f, 0.0f);
