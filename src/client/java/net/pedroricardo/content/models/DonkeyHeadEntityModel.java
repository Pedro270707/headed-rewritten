...
public class DonkeyHeadEntityModel extends SkullBlockEntityModel implements HeadedRewrittenModel {
    private final ModelPart root;
    private final ModelPart head;

    public DonkeyHeadEntityModel(ModelPart root) {
        this.root = root;
        this.head = this.root.getChild("head_parts");
    }

    public static TexturedModelData getTexturedModelData() {
        return DonkeyEntityModel.getTexturedModelData();
    }
