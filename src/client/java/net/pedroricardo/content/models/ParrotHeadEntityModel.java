...
public class ParrotHeadEntityModel extends SkullBlockEntityModel implements HeadedRewrittenModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData2 = modelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(2, 2).cuboid(-1.0F, -3.0F, -1.0F, 2.0F, 3.0F, 2.0F), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
    ...
    public Vector3f getHeadSizeInPixels() {
        return new Vector3f(2.0f, 3.0f, 2.0f);
    }
