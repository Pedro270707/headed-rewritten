...
public class HeadOptionArgumentType implements ArgumentType<Option<Object>> {
    public static final DynamicCommandExceptionType INVALID_HEAD_OPTION_EXCEPTION = new DynamicCommandExceptionType((head) -> Text.translatable("argument." + HeadedRewritten.MOD_ID + ".head_option.invalid", head));
